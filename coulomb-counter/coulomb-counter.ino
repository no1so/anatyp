...
#define INT 12 // On 328 Arduinos, only pins 2 and 3 support interrupts
#define POL 11 // Polarity signal
...
volatile double battery_mAh = 2200.0; // milliamp-hours (mAh)
volatile double battery_percent = 100.0;  // state-of-charge (percent)
...
volatile double mA;
double ah_quanta = 0.2586024091; // mAh for each INT
